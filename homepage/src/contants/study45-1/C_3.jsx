    ...
    return (
        ...
        <div className='ex'>
            ...
            <div className='talk'>
                ...
                <div id='r' style={{height:'115px'}}><p>장우혁: 한 학기동안 진행된 C언어 스터디를 통해 학교 수업만으로는 부족했거나, 완전히 이해하지 못했던 부분들을 채워나갈 수 있어서 좋았습니다. 그리고 무엇보다도 스터디원끼리 협업하여 같이 의견을 교환하면서 C 라는 언어에 대해 더 깊게 공부할 수 있었다는 점이 가장 도움이 된 것 같습니다.</p></div>
